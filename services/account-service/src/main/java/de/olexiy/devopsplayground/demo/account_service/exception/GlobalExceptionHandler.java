...
import com.bank.account.model.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> handleAccountNumberNotFound(AccountNumberNotFoundException ex, HttpServletRequest req) {
        return buildError(HttpStatus.NOT_FOUND, ex.getMessage(), req.getRequestURI());
    }

    @ExceptionHandler(CustomerNotFoundException.class)
    ResponseEntity<ErrorResponse> handleCustomerNotFound(CustomerNotFoundException ex, HttpServletRequest req) {
        return buildError(HttpStatus.NOT_FOUND, ex.getMessage(), req.getRequestURI());
    }
    ...
    ResponseEntity<ErrorResponse> handleServiceUnavailable(CustomerServiceUnavailableException ex, HttpServletRequest req) {
